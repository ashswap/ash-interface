...
const MAIAR_WALLET_LINK = {
    ...
    CHROME_EXT: "https://chrome.google.com/webstore/detail/maiar-defi-wallet/dngmlblcodfobpdpecaadgfbcggfjfnm"
}
    ...
    return (
        <>
            <ReactModal
                ...
                useClipCorner={true}
            >
                <div className="clip-corner-4 clip-corner-tl bg-ash-dark-400 py-12 px-7 w-[33.75rem] text-white">
                    <div
                        className="flex justify-center bg-no-repeat bg-left bg-contain py-8"
                        style={{
                    ...
                    >
                        {isOpenQR ? (
                            <div>
                                <WalletConnect />
                                <div
                                    className="text-ash-purple-500 uppercase text-sm text-center font-bold cursor-pointer"
                            ...
                            <div className="flex flex-col pb-16">
                                ...
                                <div
                                    className="w-[21.875rem] h-24 bg-ash-dark-600 cursor-pointer flex items-center px-6 mb-4"
                                ...
                                <div
                                    className="w-[21.875rem] h-24 bg-ash-dark-600 cursor-pointer flex items-center px-6"
            ...
            <ReactModal
                ...
                useClipCorner={true}
            >
                <div className="clip-corner-4 clip-corner-tl bg-ash-dark-400 pt-20 pb-14 px-10 text-white w-[38.75rem]">
                    <div className="flex flex-col items-center text-center">
                        <div className="text-2xl font-bold mb-9">
                            Install{" "}
                            <span className="text-ash-blue-500">
                                Maiar Wallet
                            </span>{" "}
                        ...
                        <div className="flex items-center space-x-8 mb-[5.5rem]">
                            <ICConnectApp
                                className={`${styles.dropShadowPink} text-pink-600 h-[6.75rem] w-auto`}
                            />
                            ...
                            <div className="relative w-[4.75rem] h-[4.75rem] flex items-center justify-center">
                                <div className="bg-white rounded-2xl rotate-45 absolute w-full h-full"></div>
                        ...
                        <div className="flex space-x-2 mb-7">
                            <a href={MAIAR_WALLET_LINK.PLAY_STORE} target="_blank" rel="noreferrer" className="border border-white/50 relative flex items-center px-1 py-[0.125rem] cursor-pointer">
                            ...
                            <a href={MAIAR_WALLET_LINK.APP_STORE} target="_blank" rel="noreferrer" className="border border-white/50 relative flex items-center px-1 py-[0.125rem] cursor-pointer">
                                <div className="absolute left-[-1px] h-3 border-l border-l-ash-dark-400"></div>
                                <Image
                            ...
                            <a href={MAIAR_WALLET_LINK.APP_GALLERY} target="_blank" rel="noreferrer" className="border border-white/50 relative flex items-center px-1 py-[0.125rem] cursor-pointer">
                                <div className="absolute left-[-1px] h-3 border-l border-l-ash-dark-400"></div>
                                <Image
            ...
            >
                <div className="clip-corner-4 clip-corner-tl bg-ash-dark-400 pt-20 pb-14 px-10 text-white w-[38.75rem]">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <div className="flex items-center space-x-8 mb-[5.5rem]">
                            <ICConnectExtension
                                className={`${styles.dropShadowPink} text-pink-600 w-[6.75rem] h-auto`}
                            />
                            <div className="flex items-center space-x-1">
                                <div className="w-1.5 h-1.5 bg-pink-600"></div>
                                <div className="w-1.5 h-1.5 bg-[#FF00B8]"></div>
                        ...
                        <div>
                        <a href={MAIAR_WALLET_LINK.CHROME_EXT} target="_blank" rel="noreferrer" className="border border-white/50 relative flex items-center p-1 cursor-pointer mb-5">
                                <div className="absolute left-[-1px] h-3 border-l border-l-ash-dark-400"></div>
                                <div className="clip-corner-1 clip-corner-tl bg-ash-blue-500 uppercase font-bold text-sm h-12 flex justify-center items-center text-center w-96">
                        ...
                        <span
                            className="cursor-pointer text-ash-gray-500 text-sm uppercase font-bold"
                            onClick={() => {setIsOpenDownloadExtension(false); setIsOpenQR(true)}}
                        >
                            <span>Or, use </span>
...
const WalletConnect = ({
    ...
    return (
        <div className="text-white" ref={ref}>
            <div className="text-2xl text-center font-bold mb-16">
                <span className="text-ash-blue-500">Maiar mobile </span>
                <span>login</span>
            </div>
            <div className="mx-auto mb-[2.125rem]" {...svgQr} />
            <div className="text-center mb-11 uppercase text-lg font-bold">
