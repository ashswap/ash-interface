        ...
        >
            {props.view == ViewType.List ? (
                poolType === "my-pool" ? (
                    ...
                    >
                        <div className="w-8/12 px-4 sm:px-11 flex items-center">
                            <div className="flex-grow flex space-x-4">
                                ...
                                <div className="w-5/12 sm:w-1/4 text-right sm:text-left">Your Liquidity</div>
                                <div className="hidden sm:block w-1/4">Your capacity</div>
                            </div>
                            <div className="hidden sm:block w-[7.25rem]"></div>
                        </div>
                        <div className="hidden sm:block w-4/12 pl-11 pr-1 border-l border-l-ash-gray-500">Total Farming</div>
                        <div className="block sm:hidden w-4/12 text-right pr-4">Farming</div>
                    </div>
                ) : (
                    ...
                    >
                        <div className="hidden sm:block w-3/12">Deposite</div>
                        <div className="sm:hidden w-[45%]">#Pool</div>
                        <div className="w-[18%] sm:w-2/12 text-white">APR Earn</div>
                        <div className="hidden sm:block w-3/12">Farming per day</div>
                        <div className="hidden sm:block w-2/12 text-right sm:mr-1">Total Liquidity</div>
                        <div className="w-[37%] sm:w-2/12 text-right sm:mr-4">24H Volume</div>
                    </div>
                    </div>
                )
            ) : null}
