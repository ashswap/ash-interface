                        ...
                        <div className="sm:flex sm:space-x-8 lg:space-x-24 mb-24">
                            <div className="flex flex-col flex-grow">
                                <div className="w-full grid grid-cols-2 gap-x-7.5 mb-12">
                                    ...
                                    <div>
                                        <div className="text-ash-gray-500 text-sm font-bold mb-4 flex items-center">
                                        ...
                                        <div className="bg-stake-dark-500 h-18 px-6 flex items-center justify-end text-ash-gray-500 text-lg text-right">
                                            <div className="text-right">
                                                200
                                            </div>
                                        </div>
                                        <div className="text-right text-xs mt-2 text-ash-gray-500">
                                ...
                                <div className="mb-11">
                                    <div className="text-ash-gray-500 text-sm font-bold underline mb-4">
                                        Current lock period
                                    </div>
                                    <div className="bg-stake-dark-500 text-ash-gray-500 h-20 pl-6 pr-4 flex items-center justify-between">
                                        <div className="text-2xl font-bold">
                                            {moment()
                                                .add(currentLockDays, "days")
                                                .format("DD MMM, yyyy")}
                                        </div>
                                        <div className="text-sm underline pl-5 border-l border-l-ash-gray-500">
                                            {remaining}
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div className="mt-4 flex space-x-2">
                                                {extendOpts.map((opt, i) => {
                                                    return (
                                                        <button
                                                            key={opt.value}
                                                            className={`border border-ash-gray-500 bg-ash-gray-500/10 h-12 flex items-center justify-center px-1 text-ash-gray-500 text-sm ${i === extendOpts.length - 1 ? "flex-grow" : "w-24"}`}
