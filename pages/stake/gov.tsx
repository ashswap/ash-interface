...
function GovPage() {
    return (
        <div className="ash-container text-white pt-[1.875rem]">
            ...
            <h1 className="text-pink-600 text-2xl md:text-5xl font-bold mb-7 md:mb-11">Governance Stake</h1>
            <div className="flex space-x-2">
                <button className="bg-pink-600/20 text-pink-600 h-12 px-6 flex items-center justify-center">Weekly Summary</button>
                <button className="bg-pink-600 text-white h-12 px-6 flex items-center justify-center">Add/Manage Stake</button>
            </div>
            </div>
            <GovStats/>
        </div>
