                    ...
                    <div className="mb-28 flex flex-col md:mr-[5.5rem]">
                        <Link href="/reward-pool">
                            <a>
                                <GlowingButton
                                    theme="pink"
                                    className="w-full h-16 md:h-[5.5rem] font-bold"
                                >
                                    Join Event now!
                                </GlowingButton>
                            </a>
                        </Link>
                        <div className="mt-10 font-bold text-lg text-ash-gray-500 text-center">
                            Unlock LKASH
                        </div>
                    </div>
                    <div className="relative">
                        <div className="absolute w-72 sm:w-96 md:w-[25rem] lg:w-[32rem] xl:w-[35rem] -bottom-4 -right-16 md:-bottom-20 md:-right-28 pointer-events-none">
                            <Image
                                src={ImgPhoenix}
                                alt="ashswap"
                                layout="responsive"
                        ...
                        <div className="relative">
                            ...
                            <div className="font-amaz text-7xl sm:text-9xl md:text-6xl lg:text-9xl xl:text-[150px] text-center md:text-left text-white leading-none lg:-ml-32 xl:ml-[-9.5rem]">
                                {formatAmount(TOTAL_REWARD_POOL.toBigNumber().toNumber(), {notation: "standard", isInteger: true})}
                            </div>
                        </div>
                    </div>
                </div>
