                ...
                {viewType === ViewType.Card ? (
                    ...
                    <>
                        <div className={`mb-2 md:mb-8`}>
                            <div
                                className={`flex items-center bg-stake-dark-400 text-text-input-3 h-12 text-2xs sm:text-xs border-b border-ash-dark-400 px-10 space-x-7.5`}
                            >
                                <div className="flex-grow overflow-hidden flex items-center space-x-2">
                                    <div className="flex-grow overflow-hidden">#Farm</div>
                                    <div className="flex-shrink-0 w-[18%] text-xs font-bold underline text-white">
                                        Emission APR
                                    </div>
                                    <div className="flex-shrink-0 w-[18%] text-xs underline text-right">
                                        ASH Earned
                                    </div>
                                    <div className="flex-shrink-0 w-[18%] text-xs underline text-right">
                                        LP-Staked
                                ...
                                <div className="w-[13.5rem] flex-shrink-0"></div>
                            </div>
