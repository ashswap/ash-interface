...
import ImgUSHToken from 'assets/images/ush-icon.png';
...
const LP_TOKENS: IESDTInfo[] = [
    ...
    {
        identifier: 'ALP-c18005',
        chainId: ChainId.Mainnet,
        symbol: 'ALP-RSEGLD-EGLD',
        name: 'Ashswap LP',
        decimals: 18,
    },
    {
