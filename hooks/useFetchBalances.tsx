...
import { Address, ProxyProvider, TokenOfAccountOnNetwork } from "@elrondnetwork/erdjs/out";
...
export const useFetchBalances = () => {
    const fetchBalances = useRecoilCallback(({snapshot, set}) => async () => {
        ...
        proxy.getAddressEsdtList(new Address(address)).then((resp) => {
            ...
            set(walletBalanceState, Object.fromEntries(tokenBalancesEntries));
        });
    }, []);
