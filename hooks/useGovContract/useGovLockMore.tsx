import { Address, BigUIntValue, ContractFunction, GasLimit, TokenIdentifierValue, Transaction, U64Value } from "@elrondnetwork/erdjs/out";
...
const useGovLockMore = () => {
    ...
    const lockMoreASH = useRecoilCallback(({snapshot, set}) =>
        async ({
            weiAmt,
            unlockTimestamp,
